...
//  Adapted from CodeIsland2's OpenCodeView.
//

import SwiftUI

struct OpenCodeMascotView: View {
    let state: AnimationState
    var size: CGFloat = 27
    @State private var alive = false

    private static let bodyC = Color(red: 0.22, green: 0.22, blue: 0.24)
    private static let frameC = Color(red: 0.55, green: 0.55, blue: 0.57)
    private static let faceC = Color(red: 0.85, green: 0.85, blue: 0.87)
    ...
    private func drawBlock(_ c: GraphicsContext, v: MascotV, dy: CGFloat,
                           squashX: CGFloat = 1, squashY: CGFloat = 1)
    {
        ...
        let frameRows: [(y: CGFloat, x: CGFloat, w: CGFloat)] = [(6, 3, 9), (12, 3, 9)]
